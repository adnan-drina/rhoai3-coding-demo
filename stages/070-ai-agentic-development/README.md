...
- **Same governance, different workflow.** OpenCode uses the same MaaS keys, token quotas, and model endpoints as Continue in Stage 060. The platform boundary is unchanged.
