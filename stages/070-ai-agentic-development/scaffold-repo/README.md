...
| `quarkus-migration-scaffold-v2` | `app-migration` (stage 080) | Authored in `stages/080-ai-autonomous-migration/scaffold-repo/quarkus-migration-scaffold/` |

Historical `quarkus-migration-scaffold` (v1) is not published from this tree. Do not GitHub-rename it.
