...
In Stage 100, prompt engineering is the developer practice of turning intent
...
The former Stage 110 placeholder has been merged into this Stage 100 vibe-coding flow. Later developer workflow topics are deferred in [BACKLOG.md](../../BACKLOG.md) and should be recreated only when each has a concrete implementation plan and validation path.
