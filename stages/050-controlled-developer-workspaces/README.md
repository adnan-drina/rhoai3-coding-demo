# Stage 050: Controlled Developer Workspaces
...
- `getting-started-ai-coding` for Stage 080 onboarding and MaaS client checks.
...
workspaces. This keeps the Stage 080 Red Hat build of Quarkus prompt focused on
...
Manifests: [`gitops/stages/050-controlled-developer-workspaces/base/`](../../gitops/stages/050-controlled-developer-workspaces/base/)
...
[Stage 060: AI-Assisted Application Modernization](../060-ai-assisted-application-modernization/README.md) applies governed model access to application modernization.
