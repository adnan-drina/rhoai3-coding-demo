...
log_info "  Wave 12-14:  RHOAI-owned MaaS API/controller readiness, policy prerequisites"
log_info "  Wave 15-18:  local MaaSModelRefs, auth policy, subscription"
log_info "  Wave 20-22:  gateway hostname, Grafana datasource, validation helpers"
echo ""
