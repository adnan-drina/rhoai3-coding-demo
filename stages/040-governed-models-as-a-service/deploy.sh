...
log_info "  Wave 0-10:   Connectivity Link, CNPG, Kuadrant, Authorino"
log_info "  Wave 12-14:  MaaS Config bootstrap, demo PostgreSQL, and API prerequisites"
log_info "  Wave 15-18:  local MaaSModelRefs, auth policy, subscription"
log_info "  Wave 20-22:  gateway hostname and validation helpers"
echo ""
