...
**Superseded by:** `migration/contracts/m2b-resume-ladder.md`.
...
no mid-run digest rewrite, R-M2.5 wall preference) are folded into the ladder
header. Do not reinstate this file as binding law.
