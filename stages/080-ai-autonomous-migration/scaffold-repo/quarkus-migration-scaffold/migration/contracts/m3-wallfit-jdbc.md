...
```bash
python3 .hermes/skills/sdd-readiness/scripts/check-operand-count.py . BODY.json --wall-fit
python3 .hermes/skills/sdd-readiness/scripts/check-jdbc-deps-preflight.py .
```
