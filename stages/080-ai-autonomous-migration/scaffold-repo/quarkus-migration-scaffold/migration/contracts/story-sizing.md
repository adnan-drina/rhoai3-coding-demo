...
python3 .hermes/skills/sdd/check-spec-readiness/scripts/check-operand-count.py . migration/bodies/m3-s-010.json --wall-fit
python3 .hermes/skills/sdd/check-spec-readiness/scripts/check-kanban-body.py . --body migration/bodies/m3-s-001.json
```
