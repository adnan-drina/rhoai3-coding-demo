...
re_open_trigger: "test -f evidence/derived/legacy-at-3/pom.xml && ! grep -R --quiet 'javax\\.' evidence/derived/legacy-at-3/src || echo REOPEN"
authority: Lead
concur: pending
decided_by: Lead
...
Skill `check-spec-readiness` (`check-readiness.sh`) fails if any file under
