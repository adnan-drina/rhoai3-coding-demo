...
authority live in `governance/contracts/sdd-ordering.md` (**AD-S §S.6**).
...
| P0 | Waiver re-open triggers | **Landed** — `governance/schemas/mta-exception.md` + readiness lint |
...
### Task packets (Kanban / `evidence/tasks/*.json`)
