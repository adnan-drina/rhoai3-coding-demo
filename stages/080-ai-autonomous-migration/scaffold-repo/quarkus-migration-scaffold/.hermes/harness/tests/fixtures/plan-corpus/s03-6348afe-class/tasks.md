...
- Preserve DataAccessException declarations
...
**Shape**: create
**Findings**: 
**Goal**: Port legacy repository tests to verify CRUD operations before conversion
**Target design**:
- Create test directory structure: src/test/java/com/demo/repository/
- src/test/java/org/springframework/samples/petclinic/repository/jdbc/JdbcOwnerRepositoryImplTest.java → src/test/java/com/demo/repository/jdbc/JdbcOwnerRepositoryImplTest.java
- Package rename: org.springframework.samples.petclinic → com.demo
- Test all repository implementations (JDBC, JPA, Spring Data)
- Verify findByLastName returns sorted results by lastName
- Test CRUD operations: create, read, update, delete
- Test EntityManager and DataSource dependency injection
**Acceptance**: All repository tests compile and pass; multiple persistence strategies verified; PetTypeRepository characterization tests verify PetType entity relationships

#### T-003: Convert JDBC repository implementations to CDI
**Class**: infer
**Shape**: modify
**Findings**: springboot-di-to-quarkus-00003 (22)
**Goal**: Convert JDBC repository implementations from @Autowired to constructor injection with @ApplicationScoped
**Target design**:
...
#### T-004: Convert JPA repository implementations to CDI  
**Class**: infer
**Shape**: modify
...
#### T-005: Consolidate Spring Data repositories
**Class**: infer
**Shape**: structure
