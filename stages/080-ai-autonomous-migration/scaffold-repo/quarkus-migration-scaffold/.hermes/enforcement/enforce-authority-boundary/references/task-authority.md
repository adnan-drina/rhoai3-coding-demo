...
**§16.4 proving-min write fence** (`.hermes/enforcement/enforce-authority-boundary/references/write-fence.md`) + ack
...
| Scope + deny-path write refuse | `write-fence.md` → `check-write-fence.py --body` (`files_in_scope`) |
