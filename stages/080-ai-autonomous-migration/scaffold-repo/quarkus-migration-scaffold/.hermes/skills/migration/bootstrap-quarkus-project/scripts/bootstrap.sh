...
retired. Author pom.xml per skill bootstrap-quarkus-project + BOOTSTRAP.md,
...
printf '%s\n' \
  ...
  "Author pom.xml from T-1 + tooling-pins.md; see BOOTSTRAP.md and skill bootstrap-quarkus-project." \
  >&2
exit 1
