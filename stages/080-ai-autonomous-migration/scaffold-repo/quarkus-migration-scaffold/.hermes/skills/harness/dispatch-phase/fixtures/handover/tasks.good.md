...
**Independent Test**: src/test/java/app/OwnerResourceTest.java GET /owners returns the owner list
...
## Phase 4: User Story 2 - List companions (Priority: P2)

**Goal**: Companions can be listed over HTTP

**Independent Test**: src/test/java/app/CompanionResourceTest.java GET /companions returns the companion list

### Implementation for User Story 2

- [ ] T020 [P] [US2] Create src/main/java/app/CompanionResource.java
