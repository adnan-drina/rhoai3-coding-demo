...
REQUIRED_FILES = [
    ...
    ".hermes/skills/gates/validation-release-gates/scripts/check-m4-floor-receipts.py",
    ".hermes/skills/gates/validation-release-gates/scripts/write-receipt.py",
    ...
    ".hermes/skills/analysis/mta-analysis/scripts/check-findings-handoff.py",
    ".hermes/skills/sdd/sdd-readiness/scripts/check-findings-handoff.py",
    ...
    ".hermes/skills/harness/phase-dispatch/scripts/check-specify-preseed.py",
    # Architect E-122959Z — decision-complete card lint
    ".hermes/skills/harness/phase-dispatch/scripts/check-decision-complete-cards.py",
    # Operator E-20260811T144200Z — deps + dest-inventory at create
    ".hermes/skills/sdd/sdd-readiness/scripts/stamp-body-dependencies.py",
    ".hermes/skills/sdd/sdd-readiness/scripts/stamp-destination-inventory.py",
    ".hermes/skills/sdd/sdd-readiness/scripts/check-partition-coverage.py",
    ...
    ".hermes/skills/harness/auditability-repeatability/scripts/run-scoped-compile-gate.py",
    "migration/contracts/compile-scope-filtered.md",
    # Architect E-20260811T175509Z Class A — complete enforces cmd exits
    ".hermes/skills/gates/validation-release-gates/scripts/assert-complete-exit-criteria.py",
    ...
    ".hermes/skills/sdd/sdd-readiness/scripts/check-interface-closure.py",
    "migration/contracts/interface-closure.md",
    # Architect E-20260811T182820Z Class A — constraints preservation on amend
    ".hermes/skills/sdd/sdd-readiness/scripts/assert-constraints-preserved.py",
    ...
    ".hermes/skills/harness/auditability-repeatability/scripts/check-body-digest-match.py",
    "migration/contracts/body-digest-own-story.md",
    # Architect E-20260811T200911Z Class A — mint-completeness + park-at-birth
    ".hermes/skills/sdd/sdd-readiness/scripts/assert-mint-constraints-complete.py",
    ...
    ".hermes/skills/sdd/sdd-readiness/scripts/assert-dependency-closure.py",
    ...
    ".hermes/skills/harness/auditability-repeatability/scripts/assert-card-body-digest-match.py",
    ...
    ".hermes/skills/harness/harness-validate/scripts/check-skill-conformance.py",
    ".hermes/skills/harness/phase-dispatch/scripts/assert-bundle-skills-exist.py",
    ".hermes/home/skill-bundles/m3-implementer.yaml",
    # Architect E-20260812T074514Z RW-2 BANK-DEST-INV-HARDINVOKE-1
    ".hermes/skills/sdd/sdd-readiness/scripts/assert-dest-inventory-hardinvoke.py",
...
REQUIRED_SUBSTRINGS = [
    ...
    (
        ".hermes/skills/harness/phase-dispatch/scripts/create-m3-implementer.sh",
    ...
    (
        ".hermes/skills/harness/phase-dispatch/scripts/dispatch-phase.sh",
        "check-create-path-tip-sync.py",
    ...
    (
        ".hermes/skills/harness/phase-dispatch/scripts/check-phase-body-script-refs.py",
        "BODY_SCRIPT_LINT",
    ...
    (
        ".hermes/skills/harness/phase-dispatch/scripts/check-phase-input-manifest.py",
    ...
    (
        ".hermes/skills/harness/phase-dispatch/scripts/check-completion-na-reject.py",
        "COMPLETION_NA",
    ...
    (
        ".hermes/skills/sdd/specify-workspace-init/scripts/init-workspace.sh",
    ...
    (
        ".hermes/skills/sdd/sdd-readiness/scripts/check-operand-count.py",
        "build_config",
    ...
    (
        ".hermes/skills/harness/phase-dispatch/scripts/check-created-cards-claim.py",
    ...
    (
        ".hermes/skills/sdd/sdd-readiness/scripts/specimen_agnostic.py",
        "path_rewrites",
