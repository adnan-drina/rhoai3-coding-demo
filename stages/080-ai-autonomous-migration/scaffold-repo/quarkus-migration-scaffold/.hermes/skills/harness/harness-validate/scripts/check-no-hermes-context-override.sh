...
Examples:
  bash .hermes/skills/harness/harness-validate/scripts/check-no-hermes-context-override.sh
  bash .hermes/skills/harness/harness-validate/scripts/check-no-hermes-context-override.sh --help
