...
consumes signal. Enforced by lint.
...
| Was | Now | Reason |
|-----|-----|--------|
| `analysis/mta-analysis` | `analysis/scan-with-mta` | N1, N2 |
| `gates/domain-gates` | `gates/check-domain-parity` | N1, N2 |
| `gates/validation-release-gates` | `gates/check-release-readiness` | N1, N2 |
| `harness/auditability-repeatability` | `harness/record-run-evidence` | N1 (quality → action) |
