...
description: Before advancing, requeueing or shipping — lint verdict tokens and M4/M5 floor receipts. Do not use for domain parity (check-domain-parity) or phase-dispatch matrix (deleted in v2).
license: Apache-2.0
