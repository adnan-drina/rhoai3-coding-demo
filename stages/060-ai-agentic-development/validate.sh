#!/usr/bin/env bash
# Stage 060: Agentic Development - Validation
set -euo pipefail
...
echo "Stage 060: Agentic Development — Validation"
echo ""

log_step "Argo CD Application"
check_argocd_app "060-ai-agentic-development"
...
check "workspace MaaS key Secret exists (Stage 050)" \
