...
- Chapter 1. Introduction to the migration toolkit for applications
  - MTA features and RBAC
  - MTA rules and analyzers
  - MTA tools (UI, CLI, Operator, IDE add-ons)
- Chapter 2. Supported migration paths
  - Java migration paths table
  - .NET migration paths (Developer Preview)
- Chapter 3. Installing the MTA user interface
...
- Chapter 4. Installing the MTA CLI
  - Installing CLI via .zip file
  - Installing CLI on disconnected environments
  - Installing CLI for Docker on Windows
- Appendix A. Contributing to MTA
...
- Running analyses or assessments (use mta-cli/mta-ui skills)
- Developer Lightspeed configuration or AI-assisted features
- Custom rules authoring or migration rule development
- MTA release notes or version history
- MTA versions prior to 8.0
- Application portfolio management or assessment questionnaires
