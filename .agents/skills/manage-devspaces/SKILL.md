...
- **Cloned repos**:
  - `https://github.com/adnan-drina/getting-started-ai-coding.git` — Stage 050 onboarding and MaaS checks
...
- **GitOps**: Managed by ArgoCD `050-ai-assisted-development` Application with `Replace=true` sync option
- **Manifest**: `gitops/stages/050-ai-assisted-development/base/devspaces/workspaces.yaml`
...
oc patch application 050-ai-assisted-development -n openshift-gitops --type=json \
...
sleep 5
oc apply -f gitops/stages/050-ai-assisted-development/base/devspaces/workspaces.yaml
oc patch application 050-ai-assisted-development -n openshift-gitops --type=merge \
