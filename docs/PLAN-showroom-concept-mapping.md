...
| M5 Secure development | Dependency Analytics in DevSpaces, ACS scan, **TAS signing**, SBOM, **SLSA via Tekton Chains** | **080 implementation** | This is the concrete recipe our 080 was missing: Tekton Chains + TAS + SBOM in a pipeline for the Stage 070 migrated app. Dependency Analytics plugin is a cheap 050 workspace addition. |
